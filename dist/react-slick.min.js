          ...
          P = function(e) {
            ...
            if (
              ...
              if (
                ...
                (g = o ? r + C(e) : r), (n = m && m.children[g]);
                for (var S = (t = 0); S < g; S++)
                  t -= m && m.children[S] && m.children[S].offsetWidth;
            ...
            function e(t) {
              ...
              return (
                ...
                ge(ye(n), "componentDidUpdate", function() {
                  if (
                    (n.props.onReInit && n.props.onReInit(), n.props.lazyLoad)
                  ) {
                    var e = h(he({}, n.props, n.state));
                    0 < e.length &&
                      (n.setState(function(t) {
                ...
                ge(ye(n), "onClickImage", function(e) {
                  if (e.onclick) {
                    var t = e.onclick;
                    e.onclick = function() {
                ...
                ge(ye(n), "onLoadImage", function(e, t) {
                  e.onload ||
                    (n.props.lazyLoad
                      ? (e.onload = function() {
                          n.adaptHeight(),
                  ...
                  if (d) {
                    ...
                    a && 0 < v.length && a(v),
                      n.setState(d, function() {
                        i &&
                          i.innerSlider.state.currentSlide !== o &&
